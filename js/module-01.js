...
/* Регулярні вирази 
В цьому коді ми використовуємо регулярний вираз /[aeiouy]/gi, що означає:
*/
// function vowelCount(str) {
...
/** 
[aeiou]: будь-яка з голосних літер (маленька або велика).
g: пошук всіх співпадінь.
i: регістронезалежний пошук.
Ми використовуємо .match(regex), щоб знайти всі співпадіння з регулярним виразом у рядку. Якщо співпадіння знайдені, ми повертаємо довжину масиву matches, яка представляє кількість голосних літер. Якщо співпадіння не знайдені, повертаємо 0.

В цьому коді ми використовуємо регулярний вираз /[aeiou]/gi, що означає:

[aeiou]: будь-яка з голосних літер (маленька або велика) в англійському тексті.
g: пошук всіх співпадінь.
i: регістронезалежний пошук.
Ми використовуємо .match(regex), щоб знайти всі співпадіння з регулярним виразом у рядку. Якщо співпадіння знайдені, ми повертаємо довжину масиву matches, яка представляє кількість голосних літер. Якщо співпадіння не знайдені, повертаємо 0.
*/